...
V4=function(e,y,...) y=y or 8
    local u=Instance.new ( "Part" )u.Name = "SafetyFloorPadAntiVoid" u.Size =Vector3.new ( 28 , 1.5 , 28 )u.Position =e-Vector3.new ( 0 , 3.2 , 0 )u.Anchored = true u.Transparency = 1 u.CanCollide = true u.Parent =r task.delay (y,function(...) pcall(function(...) u:Destroy()
        end
        )
    end
    )
...
v4=function(e,r,y,...)
    ...
    if a> 8 then
        h.statusText = "[Place] Tweening back to base plot..." g4(e or h.glideSpeed or 1000 ,r, true )
    end
...
local uk= 5 K4=function(e,...)
    ...
    if k> 8 then
        h.statusText = "[AutoPlace] Tweening home to base plot..." g4(h.glideSpeed or 1000 ,r, true )
    end
    if u then
                ...
                if g then
                    ...
                    if r.Mutations and type(r.Mutations )== "table" then
                        for e,r in pairs(r.Mutations )do
                            local y=(type(r)== "table" and tonumber(r.Multiplier or r.Value ))or tonumber(r)or 1.5 a=ay
                        end
...
local function oM(...)
    ...
    if r then
        ...
        local v=t task.spawn (function(...) task.wait ( 0.1 )
            ...
            if e then
                if e.AnchorPoint.Y ~= 0 then
                    local y=e.Size.Y .Offset > 0 and e.Size.Y .Offset or t e.Position =UDim2.new (e.Position.X .Scale ,e.Position.X .Offset ,e.Position.Y .Scale ,e.Position.Y .Offset -(ye.AnchorPoint.Y ))e.AnchorPoint =Vector2.new ( 0.5 , 0 )
                end
        ...
        [ "Max" ]= 1000 ;
        [ "Default" ]=h.glideSpeed or 1000 },[ "Callback" ]=function(e,...) h.glideSpeed =e Y(e)
        end
            ...
            while h.alive do
                pcall(function(...)
                    ...
                    if Fk.paraLiveDash and Fk.paraLiveDash.SetDesc then
                        ...
                        local k=string.format (j,u,e,r,h.glideSpeed or 1000 )pcall(function(...) Fk.paraLiveDash :SetDesc(k)
                        end
                        )
                    end
                end
    ...
    (Instance.new ( "UICorner" ,m)).CornerRadius =UDim.new ( 0 , 6 )W.MouseButton1Click :Connect(function(...) h.glideSpeed =math.max ( 100 ,((h.glideSpeed or 1000 ))- 25 )T.Text =string.format ( "%d Studs/s" ,h.glideSpeed )Y(h.glideSpeed )
    end
    )m.MouseButton1Click :Connect(function(...) h.glideSpeed =math.min ( 1000 ,((h.glideSpeed or 1000 ))+ 25 )T.Text =string.format ( "%d Studs/s" ,h.glideSpeed )Y(h.glideSpeed )
    end
